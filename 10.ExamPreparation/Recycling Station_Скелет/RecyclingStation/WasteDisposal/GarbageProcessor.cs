namespace RecyclingStation.WasteDisposal
{
    ...
    public class GarbageProcessor : IGarbageProcessor
    {
        ...
        public IProcessingData ProcessWaste(IWaste garbage)
        {
            ...
            {
                Type typeOfCorrespongingStrategy = disposalAttribute.CorrespondingStrategyType;
                IGarbageDisposalStrategy activatedStrategy = (IGarbageDisposalStrategy)Activator.CreateInstance(typeOfCorrespongingStrategy);
