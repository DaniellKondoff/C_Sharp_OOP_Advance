...
public class GameController
{
    ...
    public MissionController MissionControllerField
    {
        ...
        private set { this.missionControllerField = value; }
    }
    ...
    {
        return this.output.GiveOutput(result, army, wearHouse, this.MissionControllerField.Missions.Count);
    }
    ...
    private void AddAmmunitions(Ammunition ammunition)
    {
        ...
        {
            this.WearHouse[ammunition.Name][0].WearLevel += ammunition.WearLevel;
        }
    }
